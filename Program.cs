 ...
 * Eric Martinez
 * July 19, 2025
 * Week 4 Project - Simple Calculator App
 * C#
...
class CalculatorApp
{
            ...
            case 4:
                ...
                while (!valid)
                {
                    try
                    {
                        ...
                        double result = Calculator.Divide(divNum1, divNum2);
                        Console.WriteLine($"{divNum1} ÷ {divNum2} = {result}\n");
                        valid = true;
                    }
                    catch (Exception ex)
                    {
    ...
    static void Main()
    {
        Console.WriteLine("Eric Martinez - Project Week 4 - Exception Handling");
